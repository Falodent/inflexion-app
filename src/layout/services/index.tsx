...
const Services = () => {
  return (
    <section className="w-full pt-30 flex flex-col gap-[220px]">
      <Clients />

      <div className="flex flex-col gap-[42px]">
        <div className="w-full px-8">
          <h1 className="w-full max-w-[810px] font-[700] text-[62px] leading-[60px] -tracking-[0.03em] pr-2">
        ...
        <h4 className="text-xl leading-none -tracking-[0.03em] text-black-100 px-9">
          We specialize in the AI and human capabilities to solve them.
        </h4>
      </div>

      <div className="w-full border-y border-grey-200 grid grid-cols-3 px-9">
