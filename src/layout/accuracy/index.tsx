  ...
  return (
    <div ref={scrollContainer} className="w-full bg-white px-4 lg:px-8 py-32">
      <div className="w-full h-[595px] pb-[52px] pt-[113px] flex flex-col gap-[120px] bg-black-100 rounded-3xl">
        <div className="font-[700] text-white text-[42px] lg:text-[80px] leading-none -tracking-[0.04em]">
          <p className={clsx("pl-[30px] lg:pl-[82px] w-full", bordered)}>
            When accuracy <span className="hidden lg:inline">drives</span>
          </p>

          <p
            className={clsx(
              "lg:hidden pl-[30px] lg:pl-[82px] w-full",
              bordered
            )}
          >
            drives alpha,
          ...
          <p className={clsx("pl-[30px] lg:pl-[82px] w-full my-1", bordered)}>
