...
const Specialty = () => {
  return (
    <PageEntrance className="w-full bg-white py-20 lg:py-40 px-4 lg:px-32 flex flex-col gap-20 lg:gap-[98px]">
      <p className="max-w-[350px] lg:max-w-[800px] font-[750] text-[40px] lg:text-[62px] leading-[90%] -tracking-[0.02em] lg:-tracking-[0.01em] uppercase">
        Your Seasonality is Our Specialty
      </p>

      <div className="max-w-[350px] lg:max-w-full flex flex-col gap-8">
