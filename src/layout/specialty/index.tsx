...
const Specialty = () => {
  return (
    <PageEntrance className="w-full bg-white py-20 lg:py-40 px-4 lg:px-32 flex flex-col gap-20 lg:gap-[98px]">
      <p className="max-w-[350px] md:max-w-[800px] font-[750] text-[36px] xs:text-[40px] md:text-[62px] leading-[90%] -tracking-[0.02em] lg:-tracking-[0.01em] uppercase">
      ...
      <div className="max-w-[350px] md:max-w-full flex flex-col gap-8">
        <div className="flex items-center gap-5">
          ...
          <p className="sm:text-xl -tracking-[0.01em] text-black">
