...
const FAQ = () => {
  return (
    <PageEntrance className="w-full py-32 flex flex-col gap-14 lg:gap-20 bg-white">
      <p className="max-w-[305px] md:max-w-full font-[800] text-[48px] leading-[59px] md:text-[62px] md:leading-[80px] -tracking-[0.04em] uppercase text-black-100 px-4 lg:px-8">
