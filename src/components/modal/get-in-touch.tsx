    ...
    <>
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <motion.div
              className="h-[90vh] max-h-[988px] bg-white rounded-[18px] w-full max-w-[368px] md:max-w-[810px] py-16 px-5 lg:p-16 lg:pl-10 relative overflow-y-auto flex flex-col gap-12.5"
            ...
            >
              <button
                className="absolute right-5 top-16 lg:right-13 text-black cursor-pointer hover:scale-105 transition-all ease-in-out"
                onClick={handleClose}
              >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-14">
                ...
                <TextField
                  ...
                  placeholder="e.g, internet@provider.com"
                />
