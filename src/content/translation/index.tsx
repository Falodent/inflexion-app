...
export const Translations: Record<string, Props> = {
  Japanese: {
    ...
    icon: "japan.svg",
    coordinates: "top-12 right-3 lg:top-20 lg:right-21",
  },
  Hindi: {
  ...
  Spanish: {
    ...
    icon: "spain.svg",
    coordinates: "top-32 lg:top-47 left-[53%] transform -translate-x-1/2",
  },
  French: {
  ...
  Mandarin: {
    ...
    icon: "china.svg",
    coordinates: "top-12 right-4 lg:top-20 lg:right-24",
  },
  German: {
    text: "Audio ist die am wenigsten genutzte Datenquelle.",
    icon: "germany.svg",
    coordinates:
      "top-30 lg:top-45 left-1/2 md:left-[55%] lg:left-1/2 transform -translate-x-1/2",
  },
  Portuguese: {
  ...
  Korean: {
    ...
    icon: "korea.svg",
    coordinates: "top-13 right-5 lg:top-18 lg:right-19",
  },
};
